...
/**
 * @ORM\Entity(repositoryClass="Shanbo\ImmobilierBundle\Repository\ShStatAgenceRepository")
 */
class ShStatAgence
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Shanbo\ImmobilierBundle\Entity\ShAgence", inversedBy="stats")
    ...
    {
        return $this->tot_biens;
    }

    public function setTotBiens(int $tot_biens): self
    {
        $this->tot_biens = $tot_biens;
