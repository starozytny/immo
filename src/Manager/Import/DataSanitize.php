...
namespace App\Manager\ImportData;
...
abstract class DataSanitize
{
    ...
    protected function setCodeBien($item)
    {
        switch ($item) {
            case 'Maison':
            case 'Maison/villa':
                return ShBien::TYPE_MAISON;
                break;
            case 'Appartement':
                return ShBien::TYPE_APPARTEMENT;
                break;
            case 'Parking':
            case 'Parking/box':
            case 'Box':
                return ShBien::TYPE_PARKING;
                break;
            case 'Bureaux':
                return ShBien::TYPE_BUREAUX;
                break;
            case 'Local':
                return ShBien::TYPE_LOCAL;
                break;
            case 'Immeuble':
                return ShBien::TYPE_IMMEUBLE;
                break;
            case 'Terrain':
    ...
    protected function setSlugAnnonce($codeTypeAnnonce){
        switch ($codeTypeAnnonce) {
    ...
    protected function setSlugBien($item)
    {
        switch ($item) {
    ...
    protected function setSlugVille($ville){
    ...
    protected function setSlugRef($ref){
        $pos = strpos($ref,'|');
