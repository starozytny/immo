...
/**
 * @ORM\Entity(repositoryClass="App\Repository\ShAgenceRepository")
 */
class ShAgence
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\ShBien", mappedBy="agence", orphanRemoval=true)
     */
    private $biens;

    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\ShCategorie", inversedBy="agences")
     */
    private $categories;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\ShStatAgence", mappedBy="agence")
     */
    private $stats;
