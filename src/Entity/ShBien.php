...
/**
 * @ORM\Entity(repositoryClass="App\Repository\ShBienRepository")
 */
class ShBien
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\ShAgence", inversedBy="biens")
     * @ORM\JoinColumn(nullable=false)
     */
    private $agence;

    /**
     * @ORM\OneToOne(targetEntity="App\Entity\ShFinancier", cascade={"persist", "remove"})
     * @ORM\JoinColumn(nullable=false)
     */
    private $financier;

    /**
     * @ORM\OneToOne(targetEntity="App\Entity\ShCopro", cascade={"persist", "remove"})
     * @ORM\JoinColumn(nullable=false)
     */
    private $copro;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\ShResponsable", inversedBy="shBiens")
     */
    private $responsable;

    /**
     * @ORM\OneToOne(targetEntity="App\Entity\ShDiagnostic", cascade={"persist", "remove"})
     * @ORM\JoinColumn(nullable=false)
     */
    private $diagnostic;

    /**
     * @ORM\OneToOne(targetEntity="App\Entity\ShCaracteristique", cascade={"persist", "remove"})
     * @ORM\JoinColumn(nullable=false)
     */
    private $caracteristique;

    /**
     * @ORM\OneToOne(targetEntity="App\Entity\ShAdresse", cascade={"persist", "remove"})
     * @ORM\JoinColumn(nullable=false)
     */
    private $adresse;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\ShImage", mappedBy="bien", orphanRemoval=true)
     */
    private $images;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\ShDemande", mappedBy="bien", orphanRemoval=true)
     */
    private $demandes;
